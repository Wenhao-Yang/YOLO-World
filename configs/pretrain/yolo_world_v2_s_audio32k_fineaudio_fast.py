...
load_from = 'pretrained/audio_ckp_mix.pth'

# img_scale = (1280, 1280)
img_scale = _base_.img_scale
model_fp = '/home/yangwenhao/project/SpeechCLIP/exp/mix/text_uniq/spchclp_p_mix_audio_text3_aug/epoch=5-step=15999-val_recall_mean_10=84.2900.ckpt'
...
coco_train_dataset = dict(
    ...
    # ann_file='annotations/final_flickr_separateGT_train_8k2.json',
    ann_file='annotations/final_mixed_train_8k_caps.json',
    # ann_file='annotations/final_flickr_separateGT_train_32k3.json',
    data_prefix=dict(img='images/'),
    filter_cfg=dict(filter_empty_gt=True, min_size=32),
    pipeline=train_pipeline)
...
test_audio_transform = [
    # dict(type='LoadAudio',
    #     audio_path='data/audios/lvis_v1_class_audio.json'),
...
optim_wrapper = dict(optimizer=dict(
    ...
    paramwise_cfg=dict(bias_decay_mult=0.0,
                        ...
                        custom_keys={
                            ...
                            dict(lr_mult=0.1, weight_decay=1e-5),
                            'bbox_head':
                            dict(lr_mult=0.1),
                            'neck':
                            dict(lr_mult=0.1),

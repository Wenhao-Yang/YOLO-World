...
#  mix_no_image_text_relate2_aug coco_neg_2k lvis_metrics
# lvis/bbox_AP: 0.3430  lvis/bbox_AP50: 0.4810  lvis/bbox_AP75: 0.3720  lvis/bbox_APs: 0.1610  lvis/bbox_APm: 0.4340  lvis/bbox_APl: 0.5320  lvis/bbox_APr: 0.4600  lvis/bbox_APc: 0.3210  lvis/bbox_APf: 0.2830  data_time: 0.0016  time: 0.1230

#  mix_no_image_text_relate2_aug lvis_512 lvis_metrics
...
flickr_train_dataset = dict(
    ...
    ann_file='annotations/final_flickr_separateGT_train_8k_scores_norm.json',
...
gqa_train_dataset = dict(
    ...
    ann_file='annotations/final_mixed_train_17k_norm_scores.json',
...
coco_val_dataset = dict(
    ...
    dataset=dict(type='YOLOv5LVISV1Dataset',
                 ...
                 batch_shapes_cfg=None),
    class_text_path='data/texts/lvis_v1_class_texts.json',
    class_audio_path='data/audios/lvis_v1_class_audio2.json',
    pipeline=test_pipeline)
